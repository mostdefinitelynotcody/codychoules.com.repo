        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            ...
            <section className="bg-[#18181b] border border-[#27272a] rounded-2xl p-6">
              <span className="text-[10px] uppercase tracking-[0.1em] text-[#71717a] font-bold mb-4 block">Professional Summary</span>
              <p className="text-[13px] leading-[1.6] text-[#d4d4d8]">
                Career transitioning candidate with a computer science degree path (WGU, ML specialization), hands on SQL, Python, Linux, &amp; data integration experience, &amp; a decade of functional delivery in technical environments. Ten years at Landmark six of which focused on combined independent IT &amp; database ownership with dataset work &amp; stakeholder facing analysis. Currently studying CompTIA Security+ &amp; shadowing a SOC analyst to deepen fraud &amp; security fundamentals. Comfortable scoping unfamiliar technical territory, learning new frameworks, &amp; translating messy real world inputs into structured, documented outputs with a passion for ML, its history, and helping to use it to combat its increasing unethical use. My skills can be a valuable asset in reigning in hype &amp; conveying the risks of ML to stakeholders while integrating 3rd party ML tools/APIs or designing in house ML tools to meet the needs of our team.
              </p>
            </section>
          ...
          <div className="lg:col-span-8 flex flex-col gap-4">
            ...
            {/* Experience */}
            <section className="bg-[#18181b] border border-[#27272a] rounded-2xl p-6">
              <span className="text-[10px] uppercase tracking-[0.1em] text-[#71717a] font-bold mb-6 block">Professional Experience</span>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <ul className="list-none space-y-2.5">
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      ...
                      <span>Developed and managed 3D visualizations and geospatial datasets for commercial and residential projects along multi year timespans.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Led the adoption of new digital workflows, introducing advanced visualization and geospatial tools emergent at the time such as realtime rendering, 3D topology mapping, and BIM 3D drafting &amp; version control.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Gained experience in enterprise level software including Autodesk, Archicad, and SketchUp.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Independently ran IT &amp; database needs: hardware/software setup, SQL Server touchpoints, &amp; data integration between modeling tools &amp; internal systems.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Integrated cloud data management &amp; field capture (including drone workflows) so stakeholders had timely, structured information for decisions.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Documented logic &amp; hand offs instruction so nontechnical users could independently act. Also acted as the translator between engineering intent &amp; field execution.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-none space-y-2.5">
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Directed multiple projects with strict accuracy &amp; compliance to approved plans; responsible for loss-avoidance at the project level (rework, schedule slip, material waste).</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Coordinated across crews, subcontractors, &amp; clients; balanced risk against delivery pressure day over day terminating contracts with risk introduction, compliance violation, &amp; breach of contract.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>On planning &amp; site analysis I turned complex inputs into clear instructions for nontechnical teams including high profile stakeholders via detailed walkthroughs and information presentations.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-none space-y-2.5">
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Ran daily operations, customer service, &amp; logistics for a seasonal rental business with minimal oversight. Here I drove process efficiency end to end.</span>
                    </li>
                    <li className="flex gap-3 text-[13px] leading-[1.5] text-[#a1a1aa]">
                      <span className="text-[#3f3f46] mt-0.5">&bull;</span>
                      <span>Worked independently, reducing the employer's workload and increasing operational efficiency. First line IT support for on site systems; handled user issues &amp; kept the service running.</span>
                    </li>
                  </ul>
                </div>
              </div>
